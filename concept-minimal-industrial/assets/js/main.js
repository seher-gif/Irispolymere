/* ==========================================================================
   Iris Polymere — Minimal Industrial Editorial
   Site behaviour: mobile nav, language switching, form validation,
   certificate modal, scroll-reveal, applications hover-preview.
   No external dependencies. Desktop mega menu opens via CSS
   (:hover / :focus-within) — no JS required for that.
   ========================================================================== */
(function () {
  "use strict";
